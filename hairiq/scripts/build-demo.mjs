...
const LIB_ORDER = ["config.js", "i18n-es.js", "questions.js", "principles.js", "products.js", "recommendations.js"];
...
const logo = readFileSync(join(root, "scripts", "logo-demo.webp")).toString("base64");
const out = template
